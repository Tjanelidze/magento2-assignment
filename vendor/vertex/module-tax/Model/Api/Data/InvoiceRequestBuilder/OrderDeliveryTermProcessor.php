...
use Vertex\Services\Invoice\RequestInterface as OrderRequestInterface;
use Vertex\Tax\Model\Api\Utility\DeliveryTerm;

class OrderDeliveryTermProcessor implements OrderProcessorInterface
{
    /** @var DeliveryTerm  */
     ...
     */
    public function process(OrderRequestInterface $request, OrderInterface $order): OrderRequestInterface
    {
    ...
    private function customerCountryFromRequest(OrderRequestInterface $request): string
    {
