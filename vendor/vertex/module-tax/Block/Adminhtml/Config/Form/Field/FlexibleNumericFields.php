...
/**
 * Represents a table of flexible numeric fields in the admin configuration
 */
class FlexibleNumericFields extends AbstractFieldArray implements OptionProviderInterface
{
    /** @var FlexibleFieldId */
    ...
    private function getFieldSourceRenderer()
    {
        if (!$this->fieldSourceRenderer) {
            ...
            $this->fieldSourceRenderer->setType(FlexibleFieldSource::TYPE_NUMERIC);
        }
