...
class Interceptor extends \Magento\Theme\Model\ResourceModel\Theme\File\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setDefaultOrder($direction = 'ASC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setDefaultOrder', func_get_args(), $pluginInfo) : parent::setDefaultOrder($direction);
    }
    ...
    public function addThemeFilter(\Magento\Framework\View\Design\ThemeInterface $theme)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addThemeFilter', func_get_args(), $pluginInfo) : parent::addThemeFilter($theme);
    }
