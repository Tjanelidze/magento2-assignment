...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function aggregateProductsByTypes($orderId, $productTypeIds = [], $isProductTypeIn = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('aggregateProductsByTypes', func_get_args(), $pluginInfo) : parent::aggregateProductsByTypes($orderId, $productTypeIds, $isProductTypeIn);
    }
