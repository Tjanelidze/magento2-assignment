...
class Interceptor extends \Magento\Security\Model\ResourceModel\AdminSessionInfo\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function updateActiveSessionsStatus($status, $userId, $sessionIdToExclude, $updateOlderThen = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('updateActiveSessionsStatus', func_get_args(), $pluginInfo) : parent::updateActiveSessionsStatus($status, $userId, $sessionIdToExclude, $updateOlderThen);
    }
    ...
    public function filterByUser($userId, $status = 1, $sessionIdToExclude = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('filterByUser', func_get_args(), $pluginInfo) : parent::filterByUser($userId, $status, $sessionIdToExclude);
    }
    ...
    public function filterExpiredSessions($sessionLifeTime)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('filterExpiredSessions', func_get_args(), $pluginInfo) : parent::filterExpiredSessions($sessionLifeTime);
    }
    ...
    public function deleteSessionsOlderThen($timestamp)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('deleteSessionsOlderThen', func_get_args(), $pluginInfo) : parent::deleteSessionsOlderThen($timestamp);
    }
